...
export class AreaChartBasicExample extends React.Component<
  {},
  IAreaChartBasicState
> {
  ...
  private _basicExample(): JSX.Element {
    ...
    return (
      <>
        ...
        <ChoiceGroup
          options={options}
          defaultSelectedKey="basicExample"
        ...
        {this.state.showAxisTitles && (
          <div style={rootStyle}>
            <AreaChart
              ...
              onRenderCalloutPerDataPoint={(props: ICustomizedCalloutData) =>
                props && this.state.isCalloutselected ? (
                  <ChartHoverCard
                    ...
                    YValue={`${
                      props.values[0].yAxisCalloutData || props.values[0].y
                    } h`}
              ...
              xAxisTitle={
                this.state.showAxisTitles ? "Number of days" : undefined
              }
            />
          </div>
        )}
