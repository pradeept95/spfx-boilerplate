/* eslint-disable */
import { ActionButton, Callout, DefaultPalette, FontIcon, IStackItemStyles, IStackTokens, mergeStyles, mergeStyleSets, Separator, Stack } from "@fluentui/react";
import { useBoolean, useId } from "@fluentui/react-hooks";
import { useObservableState } from "observable-hooks";
import * as React from "react";
import { ColseCalloutIcon, openCalloutIcon, sortAscIcon, sortDescIcon, unsortedIcon } from "../../../defaults/icons";
...
export const CardModeHeaderAction: React.FunctionComponent<{ column: IDataGridColumn<any> }> = ({ column }): JSX.Element => {
